...
const AllRooms = () => {
  ...
  // Function to check if a room matches the slected price ranges
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24">
      <div>
        <div className="flex flex-col items-start text-left">
          ...
          <p className="text-sm md:text-base text-gray-500/90 mt-2">
            Browse our wide range of rooms designed for every kind of traveler.
            Whether you’re looking for comfort, luxury, or budget-friendly
            options, you’ll find the perfect stay here.
          </p>
        </div>
      ...
      {/* Filters */}
      <div className="bg-white w-80 border border-gray-300 text-gray-600 mb-10 max-lg:mb-8 min-lg:ml-16">
        <div
