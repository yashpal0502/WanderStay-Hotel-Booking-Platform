...
export const cities = ["Gurgaon", "Delhi", "Mumbai", "Hyderabad"];
...
export const testimonials = [
  {
    ...
    rating: 5,
    review:
      "I've used many booking platforms before, but none compare to the personalized experience and attention to detail that WanderStay provides.",
  },
  {
    id: 2,
    name: "Liam Johnson",
    ...
    rating: 4,
    review:
      "WanderStay exceeded my expectations. The booking process was seamless, and the hotels were absolutely top-notch. Highly recommended!",
  },
  {
    id: 3,
    name: "Sophia Lee",
    ...
    rating: 5,
    review:
      "Amazing service! I always find the best luxury accommodations through WanderStay. Their recommendations never disappoint!",
  },
];
